...
\COPY ProductReviewsUpvotes FROM 'ProductReviewsUpvotes.csv' WITH DELIMITER ',' NULL '' CSV
\COPY SellerReviewsUpvotes FROM 'SellerReviewsUpvotes.csv' WITH DELIMITER ',' NULL '' CSV
